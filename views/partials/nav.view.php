        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/php" class="<?php if ($_SERVER['REQUEST_URI'] == '/php/') { echo 'bg-gray-900 text-white'; } else { echo 'text-gray-300'; } ?> rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</a>
              <a href="/php/about" class="<?php if ($_SERVER['REQUEST_URI'] == '/php/about/') { echo 'bg-gray-900 text-white'; } else { echo 'text-gray-300'; } ?> rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white">About</a>
              <a href="/php/contact" class="<?php if ($_SERVER['REQUEST_URI'] == '/php/contact/') { echo 'bg-gray-900 text-white'; } else { echo 'text-gray-300'; } ?> rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white">Contact</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
